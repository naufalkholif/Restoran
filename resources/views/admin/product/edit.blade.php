            ...
            <div class="card-body">
                <form action="{{ route('admin.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="short_description" class="form_control" id="">{!! $product->short_description !!}</textarea>
                    </div>

                    <div class="form-group">
                        <label>Long Description</label>
                        <textarea name="long_description" class="form_control summernote" id="">{!! $product->long_description !!}</textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="seo_description" class="form_control" id="">{!! $product->seo_description !!}</textarea>
                    </div>
