    ...
    <div class="container">
        ...
        <div class="row wow fadeInUp" data-wow-duration="1s">
            <div class="col-md-8 col-lg-7 col-xl-6 m-auto text-center">
                <div class="fp__section_heading mb_25">
                    ...
                    <p>Kami adalah tim ahli yang penuh semangat dan pengalaman, siap menghadirkan inovasi dan
                        kualitas terbaik untuk Anda.</p>
                </div>
            </div>
        </div>
        ...
        <div class="row team_slider">
            ...
            <div class="col-xl-3 wow fadeInUp" data-wow-duration="1s">
                <div class="fp__single_team">
                    <div class="fp__single_team_img">
                        <img src="{{ asset('frontend/images/team4.jpg') }}" alt="team" class="img-fluid w-100">
                    </div>
                    <div class="fp__single_team_text">
                        <h4>Rifqi Ghaida</h4>
                        <p>Dokumentasi</p>
