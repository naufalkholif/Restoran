                ...
                <div class="col-lg-4 col-sm-8 col-md-6">
                    <div class="fp__footer_content">
                        <a class="footer_logo" href="index.html">
                            <img src="{{ asset('frontend/images/logo.putih.png') }}" alt="FoodPark" class="img-fluid w-100">
                        </a>
                        <span>Temukan pengalaman makan tak terlupakan dengan koleksi hidangan terbaik
                            kami di Sukha!</span>
                        <p class="info"><i class="far fa-map-marker-alt"></i> Fakultas Teknologi Informasi dan Sains Data,
            ...
            <div class="row">
                <div class="col-12">
                    <div class="fp__footer_bottom_text d-flex flex-wrap justify-content-between">
                        <p>Copyright 2025 <b>Sukha</b> All Rights Reserved.</p>
                        <ul class="d-flex flex-wrap">
                            <li><a href="#">FAQs</a></li>
